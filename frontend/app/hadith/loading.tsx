          ...
          {[...Array(6)].map((_, i) => (
            <div key={i} className="glass-card p-6 animate-pulse">
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded bg-glass-light"></div>
                <div className="w-16 h-6 rounded-full bg-glass-light"></div>
              </div>
              <div className="h-6 bg-glass-light rounded mb-2"></div>
              <div className="h-8 bg-glass-light rounded mb-2"></div>
              <div className="h-4 bg-glass-light rounded w-3/4 mb-4"></div>
              <div className="h-16 bg-glass-light rounded"></div>
            </div>
          ))}
        </div>
      </div>
